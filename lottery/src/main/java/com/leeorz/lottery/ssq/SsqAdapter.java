...
public class SsqAdapter extends BaseAdapter<SsqBean> {
    ...
    static class ViewHolder {
        @BindView(R2.id.tv_red_ball1)
        TextView tvRedBall1;
        @BindView(R2.id.tv_red_ball2)
        TextView tvRedBall2;
        @BindView(R2.id.tv_red_ball3)
        TextView tvRedBall3;
        @BindView(R2.id.tv_red_ball4)
        TextView tvRedBall4;
        @BindView(R2.id.tv_red_ball5)
        TextView tvRedBall5;
        @BindView(R2.id.tv_red_ball6)
        TextView tvRedBall6;
        @BindView(R2.id.tv_blue_ball1)
        TextView tvBlueBall1;
        @BindView(R2.id.tv_blue_ball2)
